// Centrálne nastavenia značky/kontaktu. Doplň reálne hodnoty (sú označené TODO).
...
export const site = {
  ...
  // Linky na siete — TODO: doplň reálne URL (prázdne sa nezobrazia)
  socials: [
    { label: "Instagram", url: "https://www.instagram.com/quantryx_sound_project" },
    { label: "TikTok", url: "https://www.tiktok.com/@q.u.a.n.t.r.y.x" },
    { label: "YouTube", url: "https://youtube.com/@quantryx" },
  ],
};
